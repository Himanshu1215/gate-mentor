"""
core/syllabus_data.py
──────────────────────
Single source of truth for the GATE DA syllabus, moved out of
scripts/seed_syllabus.py so both the seed script and core/subject_map.py
(VALID_CONCEPT_IDS) can import it without a script-execution side effect.
"""
...
#   AI_*   Artificial Intelligence    GA_*  General Aptitude
...
GATE_DA_SYLLABUS = [
    ...
    # ── General Aptitude ─────────────────────────────────────────────────────
    {"concept_id": "GA_001", "subject": "General Aptitude", "topic": "General Aptitude", "subtopic": "Verbal & Quantitative Aptitude",
     "prerequisites": [], "difficulty": 4, "importance_weight": 0.6, "est_learning_time_mins": 60, "est_revision_time_mins": 15},
]
